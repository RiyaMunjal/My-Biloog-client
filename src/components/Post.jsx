...
const Post = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await axios.get(`https://my-biloog-server.onrender.com/api/post/${id}`);
  ...
  useEffect(()=>{
    const getAllposts=async()=>{
      try{
        const res=await axios.get(`https://my-biloog-server.onrender.com/api/post/?cat=${state.cat}`)
        setPosts(res.data)
  ...
  const deleteHandler=async()=>{
    ...
    const res=await axios.delete(`https://my-biloog-server.onrender.com/api/post/${id}`, {
