...
const Write = () => {
  ...
  const upload = async () => {
    try {
      ...
      const res = await axios.post("https://my-biloog-server.onrender.com/upload", formdata);
  ...
  const submitHandler = async () => {
    try {
      ...
      console.log(state);
      const res = state
        ? await axios.put(`https://my-biloog-server.onrender.com/api/post/${state?.id}` , {
            title,
            description: value,
            img: imgurl,
            cat,
        ...
        : await axios.post(
            "https://my-biloog-server.onrender.com/api/post",
            {
              title,
              description: value,
              img: imgurl,
